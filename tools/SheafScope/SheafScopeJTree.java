/**
 * Classname: SheafScopeJTree
 *
 * @author $Author: jebutler $
 *
 * @version $RCSfile: SheafScopeJTree.java,v $ $Revision: 1.19 $
 *
...
public class SheafScopeJTree extends JTree
{
  ...
  protected boolean makeChildren(SheafScopeTreeNode xparentNode, boolean xwarn)
  {
    try
    {
      ...
      cover_set_iterator itr = parent.cover_iterator(true);

      while(!itr.is_done())
      {
        SheafScopeTreeNode childNode = new SheafScopeTreeNode(parent.host(), itr.item(), showBottomsControl);
