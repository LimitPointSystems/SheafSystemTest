...
// $RCSfile: oct_generator_2.t.cc,v $ $Revision: 1.4 $ $Date: 2012/03/01 00:41:14 $

//
// Copyright (c) 2012 Limit Point Systems, Inc.
//

/// @example oct_generator_2.t.cc
/// Simple test driver for the tetgen mesh generator.

// This is a regular octahedron with each of the 8 triangular faces
// triangularized into 3 subtriangles by adding a vertex at the centroids
// (24 triangular faces, 36 edges, and 14 vertices).
...
{
  const size_type lnode_id_ct = 72;
  const pod_index_type lnode_ids[72] =
  {
     6, 0, 2,
     6, 2, 4,
     6, 4, 0,
...
get_coordinates(vector<e3_lite>& xcoords)
{
  ...
  const int lcoords_ct = 42;
  const e3_lite lcoords_array[42] =
  {
    e3_lite( 0,  0, -1), //  vertex  0
    e3_lite( 0,  0,  1), //  vertex  1
    e3_lite( 0, -1,  0), //  vertex  2
    e3_lite( 0,  1,  0), //  vertex  3
    e3_lite(-1,  0,  0), //  vertex  4
    e3_lite( 1,  0,  0), //  vertex  5

    e3_lite(-C, -C, -C), //  vertex  6
    e3_lite( C, -C, -C), //  vertex  7
    e3_lite( C,  C, -C), //  vertex  8
    e3_lite(-C,  C, -C), //  vertex  9
    e3_lite(-C, -C,  C), //  vertex 10
    e3_lite( C, -C,  C), //  vertex 11
    e3_lite( C,  C,  C), //  vertex 12
    e3_lite(-C,  C,  C), //  vertex 13
  };
