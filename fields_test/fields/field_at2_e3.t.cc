...
// $RCSfile: field_at2_e3.t.cc,v $ $Revision: 1.8 $ $Date: 2012/03/01 00:41:03 $

//
// Copyright (c) 2012 Limit Point Systems, Inc.
//

/// @example field_at2_e3.t.cc
/// Test driver for class field_at2_e3.
...
main(int xargc, char *xargv[])
{
  ...
  test_field_assignment<field_at2_e3>(lns, lbase_path, lcoords_path);

  // Test vd facet:

  test_field_vd_facet<field_at2_e3>(lns, lbase_path, lcoords_path);
  ...
  test_field_star_operator<field_at2_e3, field_e3>
    (lns, lbase_path, lcoords_path);

  test_field_star_operator<field_e3, field_at2_e3>
    (lns, lbase_path, lcoords_path);
