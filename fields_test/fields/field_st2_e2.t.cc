...
// $RCSfile: field_st2_e2.t.cc,v $ $Revision: 1.7 $ $Date: 2012/03/01 00:41:04 $

//
// Copyright (c) 2012 Limit Point Systems, Inc.
//

/// @example field_st2_e2.t.cc
/// Test driver for class field_st2_e2.
...
main()
{
  ...
  const string& field_name = field_st2_e2::static_class_name();
  ...
  test_field_assignment<field_st2_e2>(lns, lbase_path, lcoords_path);

  // Test vd facet:

  test_field_vd_facet<field_st2_e2>(lns, lbase_path, lcoords_path);

  // Test st2 facet:

  test_field_st2_facet<field_st2_e2>(lns, lbase_path, lcoords_path);
