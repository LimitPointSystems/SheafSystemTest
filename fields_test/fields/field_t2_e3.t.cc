...
// $RCSfile: field_t2_e3.t.cc,v $ $Revision: 1.7 $ $Date: 2012/03/01 00:41:05 $

//
// Copyright (c) 2012 Limit Point Systems, Inc.
//

/// @example field_t2_e3.t.cc
/// Test driver for class field_t2_e3.
...
main()
{
  ...
  test_field_assignment<field_t2_e3>(lns, lbase_path, lcoords_path);

  // Test vd facet:

  test_field_vd_facet<field_t2_e3>(lns, lbase_path, lcoords_path);

  // Test alt and sym functions of the tp facet:

  test_field_tp_facet<field_t2_e3, field_at2_e3, field_st2_e3>
    (lns, lbase_path, lcoords_path);

  test_field_tensor_product<field_e3, field_e3, field_t2_e3>
    (lns, lbase_path, lcoords_path);
