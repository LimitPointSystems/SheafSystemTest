...
// $RCSfile: field_jcb_e13.t.cc,v $ $Revision: 1.5 $ $Date: 2012/03/01 00:41:04 $

//
// Copyright (c) 2012 Limit Point Systems, Inc.
//

/// @example field_jcb_e13.t.cc
/// Test driver for class field_jcb_e13.
...
main()
{
  ...
  const string& field_name = field_jcb_e13::static_class_name();
