...
function(add_library_targets)
    ...
    if(WIN64INTEL OR WIN64MSVC)
        ...
        add_dependencies(${PROJECT_NAME}-shared-lib ${${COMPONENT}_SHARED_LIB} ${GEOMETRY_SHARED_LIB})
        add_dependencies(${PROJECT_NAME}-static-lib ${${COMPONENT}_STATIC_LIB} ${GEOMETRY_STATIC_LIB})

        target_link_libraries(${${COMPONENT}_SHARED_LIB} ${GEOMETRY_SHARED_LIB} ${FIBER_BUNDLES_SHARED_LIB} ${SHEAVES_SHARED_LIB})        
        target_link_libraries(${${COMPONENT}_STATIC_LIB} ${GEOMETRY_STATIC_LIB} ${FIBER_BUNDLES_STATIC_LIB} ${SHEAVES_STATIC_LIB})   
...
function(add_bindings_targets)
    ...
    if((LINUX64INTEL OR LINUX64GNU) AND SWIG_FOUND)
        ...
        target_link_libraries(${${COMPONENT}_JAVA_BINDING_LIB} ${JDK_LIB_OPTIONS} ${HDF5_LIBRARIES} ${GEOMETRY_JAVA_BINDING_LIB} ${${COMPONENT}_SHARED_LIB} ) 
        
        # Set the classpath for this component; for downstream use.            
        set(${COMPONENT}_CLASSPATH ${GEOMETRY_CLASSPATH}:${CMAKE_ARCHIVE_OUTPUT_DIRECTORY}/${${COMPONENT}_JAVA_BINDING_JAR} CACHE STRING "Cumulative classpath for ${PROJECT_NAME}")
        ...
        add_dependencies(${${COMPONENT}_PYTHON_BINDING_LIB} ${GEOMETRY_PYTHON_BINDING_LIB} ${${COMPONENT}_SHARED_LIB})
