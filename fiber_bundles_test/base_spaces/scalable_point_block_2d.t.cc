// $RCSfile: scalable_point_block_2d.t.cc,v $ $Revision: 1.9 $ $Date: 2012/03/01 00:40:31 $

//
// Copyright (c) 2012 Limit Point Systems, Inc.
//

/// @example base_spaces/scalable_point_block_2d.t.cc
/// Test driver for timing point_block_2d performance.
...
main(int xargc, char* xargv[])
{
  ...
  test_scaling<point_block_2d, 2>(xargc, xargv, ltime_plot_types,
				  lmem_plot_types);
