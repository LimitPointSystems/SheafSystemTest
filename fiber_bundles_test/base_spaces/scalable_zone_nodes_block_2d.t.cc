...
/// @example base_spaces/scalable_zone_nodes_block_2d.t.cc
/// Test driver for timing zone_nodes_block performance in two dimensions.
...
main(int xargc, char* xargv[])
{
  ...
  test_scaling<zone_nodes_block, 2>(xargc, xargv, ltime_plot_types,lmem_plot_types);
