...
// $RCSfile: atp_x.t.cc,v $ $Revision: 1.10 $ $Date: 2012/03/01 00:40:41 $
...
//     bool leqeq = (lfiber == lvalue);
  ...
  test_atp_volatile()
  {
    ...
    test_volatile_common<atp_lite>(false);

    test_volatile_tp_facet<atp_lite>();
