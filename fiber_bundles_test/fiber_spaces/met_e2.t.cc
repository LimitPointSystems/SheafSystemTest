...
/// @example met_e2.t.cc
/// Unit test driver for class met_e2.
...
main(int xargc, char* xargv[])
{
  ...
  test_persistent_tensor_type<met_e2>(lns);

  test_volatile_type<met_e2>();

  test_tensor_conversions<met_e2>(lns);

  // Test vd facet:

  test_tensor_vd_facet<met_e2>(lns);

  // Test stp facet:

  test_stp_facet<met_e2>(lns);

  // Test st2 facet:

  test_st2_facet<met_e2>(lns);

  // Test met facet:

  test_met_facet<met_e2>(lns);
