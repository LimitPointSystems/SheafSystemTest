...
// $RCSfile: at1_x.t.cc,v $ $Revision: 1.10 $ $Date: 2012/03/01 00:40:41 $
...
//     bool leqeq = (lfiber == lvalue);
  ...
  test_at1_volatile()
  {
    ...
    test_volatile_common<at1_lite>(false);

    test_volatile_tp_facet<at1_lite>();
