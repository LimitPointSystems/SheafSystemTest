...
// $RCSfile: st2_x.t.cc,v $ $Revision: 1.10 $ $Date: 2012/03/01 00:40:41 $
...
//     bool leqeq = (lfiber == lvalue);
  ...
  test_st2_volatile()
  {
    ...
    test_volatile_common<st2_lite>(false);

    test_volatile_tp_facet<st2_lite>();
