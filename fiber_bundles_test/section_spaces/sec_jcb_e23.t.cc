...
// $RCSfile: sec_jcb_e23.t.cc,v $ $Revision: 1.7 $ $Date: 2012/03/01 00:40:55 $
...
/// Test driver for class sec_jcb_e23.
...
main()
{
  ...
  const string& section_name = sec_jcb_e23::static_class_name();
  ...
  test_assignment<sec_jcb_e23>(ns, lbase_path);
  ...
  test_sec_vd_facet<sec_jcb_e23>(ns, lbase_path);

  // Test jcb facet:

  test_sec_jcb_facet<sec_jcb_e23, sec_e2, sec_e3>(ns, lbase_path);
