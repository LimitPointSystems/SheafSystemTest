...
main(int xargc, char *xargv[])
{
  ...
  test_assignment<sec_met_e1>(lns, lbase_path);

  // Test vd facet:

  test_sec_vd_facet<sec_met_e1>(lns, lbase_path);

  // Test met facet:

  test_sec_met_facet<sec_met_e1>(lns, lbase_path);

  //============================================================================

  test_section_common_unattached<sec_met_e1>();
  test_section_common_attached<sec_met_e1>(lns, lbase_path);
