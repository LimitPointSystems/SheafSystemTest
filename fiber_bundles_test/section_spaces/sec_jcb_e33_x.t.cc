...
// $RCSfile: sec_jcb_e33_x.t.cc,v $ $Revision: 1.11 $ $Date: 2012/03/01 00:40:54 $
...
main(int xargc, char *xargv[])
{
  ...
  print_header("Begin testing sec_jcb_e33");

  //============================================================================

  test_section<sec_jcb_e33>();

  //$$SCRIBBLE: Jacobian not complete in fiber_bundles_namespace.
  //test_section2<sec_jcb_e33>();

  //============================================================================

  print_footer("Ending testing sec_jcb_e33");
