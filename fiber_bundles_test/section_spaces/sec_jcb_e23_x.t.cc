...
// $RCSfile: sec_jcb_e23_x.t.cc,v $ $Revision: 1.11 $ $Date: 2012/03/01 00:40:54 $
...
main(int xargc, char *xargv[])
{
  ...
  print_header("Begin testing sec_jcb_e23");

  //============================================================================

  test_section<sec_jcb_e23>();

  //$$SCRIBBLE: Jacobian not complete in fiber_bundles_namespace.
  //test_section2<sec_jcb_e23>();

  //============================================================================

  print_footer("Ending testing sec_jcb_e23");
