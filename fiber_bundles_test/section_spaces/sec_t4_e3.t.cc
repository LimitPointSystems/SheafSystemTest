...
// $RCSfile: sec_t4_e3.t.cc,v $ $Revision: 1.10 $ $Date: 2012/03/01 00:40:57 $
...
/// Test driver for class sec_t4_e3.
...
main(int xargc, char *xargv[])
{
  ...
  test_assignment<sec_t4_e3>(ns, lbase_path);

  // Test vd facet:

  test_sec_vd_facet<sec_t4_e3>(ns, lbase_path);
