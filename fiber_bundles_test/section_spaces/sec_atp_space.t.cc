...
namespace
{
				     ...
				     const poset_path& xvector_space_path)
  {
    ...
    atp_space& ltensor_space =
      xns.new_fiber_space<atp>("shallow_instantiation_test_atp_space", 
			       ltensor_args, 
				       ...
				       const poset_path& xvector_space_path)
  {
    ...
    sec_atp_space& lsection_space =
      xns.new_section_space<sec_atp>("shallow_instantiation_test_sec_atp_space",
				     lsection_space_args,
				     xtensor_schema_path,
				     true);
