...
main(int xargc, char *xargv[])
{
  ...
  test_assignment<sec_st2_e3>(lns, lbase_path);

  // Test vd facet:

  test_sec_vd_facet<sec_st2_e3>(lns, lbase_path);

  // Test tp facet:

  test_sec_tensor_product<sec_st2_e3, sec_e3, sec_t3_e3>(lns, lbase_path);

  //============================================================================

  test_section_common_unattached<sec_st2_e3>();
  test_section_common_attached_2<sec_st2_e3>(lns, lbase_path);
