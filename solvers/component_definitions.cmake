...
function(add_library_targets)
    if(WIN64)
        ...
        target_link_libraries(${${COMPONENT}_SHARED_LIB} ${FIBER_BUNDLES_SHARED_LIB} ${SHEAVES_SHARED_LIB})
        target_link_libraries(${${COMPONENT}_STATIC_LIB} ${FIBER_BUNDLES_STATIC_LIB} ${SHEAVES_STATIC_LIB})
...
function(add_bindings_targets)
    ...
    if((LINUX64INTEL OR LINUX64GNU) AND SWIG_FOUND)
        ...
        target_link_libraries(${${COMPONENT}_JAVA_BINDING_LIB} ${JDK_LIB_OPTIONS} ${HDF5_LIBRARIES} ${${COMPONENT}_SHARED_LIB}) 
