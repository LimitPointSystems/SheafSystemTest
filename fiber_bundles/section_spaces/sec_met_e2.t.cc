...
// $RCSfile: sec_met_e2.t.cc,v $ $Revision: 1.10 $ $Date: 2012/03/01 00:40:55 $
...
main(int xargc, char* xargv[])
{
  ...
  test_assignment<sec_met_e2>(ns, lbase_path);

  // Test vd facet:

  test_sec_vd_facet<sec_met_e2>(ns, lbase_path);

  // Test met facet:

  test_sec_met_facet<sec_met_e2>(ns, lbase_path);
