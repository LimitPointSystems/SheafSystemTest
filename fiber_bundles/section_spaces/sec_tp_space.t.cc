// $RCSfile: sec_tp_space.t.cc,v $ $Revision: 1.10 $ $Date: 2012/07/04 16:42:12 $
...
namespace
{
				     ...
				     const poset_path& xvector_space_path)
  {
    ...
    arg_list ltensor_args = tp_space::make_arg_list(2, xvector_space_path);
  
    tp_space* ltensor_space = new tp_space(xns, 
					   "shallow_instantiation_test_tp_space", 
					   ltensor_args, 
					      ...
					      const poset_path& xfiber_space_path)
  {
    ...
    poset_path lrep_path = sec_tp::standard_rep_path();
    arg_list lsssp_args = 
      binary_section_space_schema_poset::make_arg_list(lrep_path, 
						       xbase_space_path, 
						       xfiber_space_path);
    ...
    binary_section_space_schema_poset* lsssp = 
      new binary_section_space_schema_poset(xns,
					    "shallow_instantiation_test_sec_tp_schema_host",
					    lsssp_args,
					    lsssp_schema_path,
					    true);
    ...
    binary_section_space_schema_member 
      lschema_mbr(lsssp, xbase_space_path, lfiber_space_schema_path);
    lschema_mbr.put_name("shallow_instantiation_test_sec_tp_schema", true, false);
    poset_path result = lschema_mbr.path(false);
    lschema_mbr.detach_from_state();
				       ...
				       const poset_path& xvector_space_path)
  {
    ...
    arg_list lsection_space_args =
      sec_tp_space::make_arg_list(2, xvector_space_path);

    // Make the tensor section space.

    sec_tp_space* lsection_space =
      new sec_tp_space(xns,
		       "shallow_instantiation_test_sec_tp_space",
		       lsection_space_args,
		       xtensor_schema_path,
		       true);
			       ...
			       const poset_path& xtensor_fiber_space_schema_path)
  {
    ...
    arg_list lfiber_args = tp_space::make_arg_list(2, "");
    
    poset_path ltensor_schema_path =
      xns.new_tensor_section_space_schema<sec_tp>("deep_instantiation_test_sec_tp_schema", 
						  lsss_args,
    ...
    arg_list ltensor_args = sec_tp_space::make_arg_list(2, "");

    sec_tp_space& lsection_space =
      xns.new_tensor_section_space<sec_tp>("deep_instantiation_test_sec_tp_space",
					   ltensor_args,
					   ltensor_schema_path,
...
int main(int xargc, char* xargv[])
{
  ...
  // Make a schema for a concrete tp space.
