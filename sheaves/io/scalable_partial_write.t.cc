// $RCSfile: scalable_partial_write.t.cc,v $ $Revision: 1.16 $ $Date: 2012/03/01 00:41:23 $
              ...
              storage_agent& xsa)
{
  ...
  total_poset_member ltemplate(xmesh->name_space(), "cell definitions/quad");
...
main(int argc, char* argv[])
{
  ...
  mono_index lblock_i_ub          = argc > 3 ? atoi(argv[3]) : 1;
  mono_index lblock_j_ub          = argc > 4 ? atoi(argv[4]) : 1;
