...
main(int xargc, char* xargv[])
{
  ...
  print_header("Begin testing postorder_itr<unordered_set<pod_index_type> >");
  typedef unordered_set<pod_index_type> UNORDERED_SET;
  ltest &= test_default_constructor_and_destructor<postorder_itr, UNORDERED_SET>();
  ltest &= test_depth_first_itr_facet<postorder_itr, UNORDERED_SET >(lns);
  ltest &= test_filtered_depth_first_itr_facet<postorder_itr, UNORDERED_SET >(lns);
  print_footer("End testing postorder_itr<unordered_set<pod_index_type> >");
