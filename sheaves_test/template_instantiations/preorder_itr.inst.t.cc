...
main(int xargc, char* xargv[])
{
  ...
  ltest &= test_default_constructor_and_destructor<preorder_itr, ZBOOL>();
  ...
  ltest &= test_default_constructor_and_destructor<preorder_itr, SET>();
  ...
  print_header("Begin testing preorder_itr<unordered_set<pod_index_type> >");
  typedef unordered_set<pod_index_type> UNORDERED_SET;
  ltest &= test_default_constructor_and_destructor<preorder_itr, UNORDERED_SET>();
  ltest &= test_depth_first_itr_facet<preorder_itr, UNORDERED_SET >(lns);
  ltest &= test_filtered_depth_first_itr_facet<preorder_itr, UNORDERED_SET >(lns);
  print_footer("End testing preorder_itr<unordered_set<pod_index_type> >");
