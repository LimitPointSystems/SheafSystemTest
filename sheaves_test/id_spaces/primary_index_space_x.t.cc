...
/// @example primary_index_space_x.t.cc
...
int main( int argc, char* argv[])
{
  ...
  test_explicit_handle_facet<primary_index_space_handle>(lid_spaces, lspace_id);
  ...
  test_explicit_iterator_facet<primary_index_space_iterator>(lid_spaces, lspace_id);
